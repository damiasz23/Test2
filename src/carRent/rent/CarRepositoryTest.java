...
public class CarRepositoryTest {
    ...
    public void testAvaibleCar(){
        ...
        List<Car> avaibleCar = CarRepository.findAviliblecCar(ZonedDateTime.now(), ZonedDateTime.now().plusDays(3));
        ...
        List<Car> avaibleCar2 = CarRepository.findAviliblecCar(ZonedDateTime.now(), ZonedDateTime.now().plusDays(3));
